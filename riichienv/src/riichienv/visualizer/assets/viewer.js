"use strict";var RiichiEnvViewer=(()=>{var P=Object.defineProperty;var U=Object.getOwnPropertyDescriptor;var S=Object.getOwnPropertyNames;var O=Object.prototype.hasOwnProperty;var D=(k,n)=>{for(var e in n)P(k,e,{get:n[e],enumerable:!0})},F=(k,n,e,t)=>{if(n&&typeof n=="object"||typeof n=="function")for(let o of S(n))!O.call(k,o)&&o!==e&&P(k,o,{get:()=>n[o],enumerable:!(t=U(n,o))||t.enumerable});return k};var M=k=>F(P({},"__esModule",{value:!0}),k);var E={};D(E,{Viewer:()=>j});var R=k=>{let n=e=>{if(e==="back")return 9999;let t=e.slice(-1),o=parseInt(e[0]);return e.endsWith("r")&&(t=e.slice(-2,-1),o=5),({m:0,p:10,s:20,z:30}[t]||0)*10+o+(e.endsWith("r")?.5:0)};return[...k].sort((e,t)=>n(e)-n(t))},v=class{constructor(n){this.events=n,this.cursor=0,this.current=this.initialState()}getKyokuCheckpoints(){let n=[];return this.events.forEach((e,t)=>{e.type==="start_kyoku"&&n.push({index:t,round:(e.kyoku||1)-1,honba:e.honba||0})}),n}initialState(){return{players:Array(4).fill(0).map(()=>({hand:[],discards:[],melds:[],score:25e3,riichi:!1,pendingRiichi:!1,wind:0})),doraMarkers:[],round:0,honba:0,kyotaku:0,wallRemaining:70,currentActor:0}}stepForward(){if(this.cursor>=this.events.length)return!1;let n=this.events[this.cursor];return this.processEvent(n),this.cursor++,!0}stepBackward(){if(this.cursor<=0)return!1;let n=this.cursor-1;for(this.reset();this.cursor<n;)this.stepForward();return!0}jumpTo(n){for(n<0&&(n=0),n>this.events.length&&(n=this.events.length),n<this.cursor&&this.reset();this.cursor<n;)this.stepForward()}stepTurn(n,e){let t=this.cursor,o=this.events.length;if(n){for(let s=this.cursor+1;s<o;s++){let a=this.events[s];if(a.actor===e&&(a.type==="tsumo"||a.type==="dahai"||a.type==="pon"||a.type==="chi"||a.type==="kan")){t=s;break}}this.jumpTo(t)}else{for(let s=this.cursor-1;s>=0;s--){let a=this.events[s];if(a.actor===e&&(a.type==="tsumo"||a.type==="dahai"||a.type==="pon"||a.type==="chi"||a.type==="kan")){t=s;break}}this.jumpTo(t)}}reset(){this.cursor=0,this.current=this.initialState()}processEvent(n){switch(n.type){case"start_game":break;case"start_kyoku":this.current.round=(n.kyoku||1)-1,this.current.honba=n.honba||0,this.current.kyotaku=n.kyotaku||0,this.current.doraMarkers=[n.dora_marker],this.current.currentActor=n.oya,this.current.players.forEach((e,t)=>{e.hand=n.tehais[t].map(o=>o),e.discards=[],e.melds=[],e.riichi=!1,e.pendingRiichi=!1,e.score=n.scores[t]});break;case"tsumo":n.actor!==void 0&&n.pai&&(this.current.players[n.actor].hand.push(n.pai),this.current.currentActor=n.actor);break;case"dahai":if(n.actor!==void 0&&n.pai){let e=this.current.players[n.actor],t=e.hand.indexOf(n.pai);t>=0&&e.hand.splice(t,1),e.hand=R(e.hand);let o=!1;e.pendingRiichi&&(o=!0,e.pendingRiichi=!1),e.discards.push({tile:n.pai,isRiichi:o}),this.current.currentActor=n.actor}break;case"pon":case"chi":case"daiminkan":if(n.actor!==void 0&&n.target!==void 0&&n.pai&&n.consumed){let e=this.current.players[n.actor];n.consumed.forEach(o=>{let s=e.hand.indexOf(o);s>=0&&e.hand.splice(s,1)}),e.melds.push({type:n.type,tiles:[...n.consumed,n.pai],from:n.target}),this.current.currentActor=n.actor;let t=this.current.players[n.target];if(t.discards.length>0){let o=t.discards.pop();o&&o.isRiichi&&(t.pendingRiichi=!0)}}break;case"kakan":case"ankan":if(n.actor!==void 0&&n.consumed){let e=this.current.players[n.actor];n.consumed.forEach(t=>{let o=e.hand.indexOf(t);o>=0&&e.hand.splice(o,1)}),e.melds.push({type:n.type,tiles:n.consumed,from:n.actor})}break;case"reach":n.actor!==void 0&&(n.step==="1"&&(this.current.players[n.actor].pendingRiichi=!0),n.step==="2"&&(this.current.players[n.actor].riichi=!0,this.current.kyotaku+=1,this.current.players[n.actor].score-=1e3));break;case"dora":n.dora_marker&&this.current.doraMarkers.push(n.dora_marker);break;case"hora":case"ryukyoku":n.scores&&this.current.players.forEach((e,t)=>e.score=n.scores[t]);break}this.current.lastEvent=n}};var u={back:`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
...
`};var b=class{constructor(n){this.viewpoint=0;this.container=n;let e=document.getElementById("riichienv-viewer-style");e||(e=document.createElement("style"),e.id="riichienv-viewer-style",e.textContent=`
            ...
            `,document.head.appendChild(e)),this.styleElement=e}getTileHtml(n){if(n==="back")return`<div class="tile-layer"><div class="tile-bg">${u.back||u.blank}</div></div>`;let e=u.front||"",t=u[n];return t||(t=u.blank||""),`
        ...
        `}render(n){this.container.innerHTML="";let e=document.createElement("div");e.className="mahjong-board",Object.assign(e.style,{position:"relative",width:"100%",aspectRatio:"1/1",maxWidth:"900px",margin:"0 auto",backgroundColor:"#2d5a27",borderRadius:"12px",overflow:"hidden",fontSize:"14px",color:"white",fontFamily:"sans-serif",boxSizing:"border-box"});let t=document.createElement("div");t.className="center-info",Object.assign(t.style,{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%, -50%)",backgroundColor:"#1a3317",padding:"15px",borderRadius:"8px",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",zIndex:"10",boxShadow:"0 4px 6px rgba(0,0,0,0.3)",minWidth:"120px"}),t.innerHTML=`
            ...
            <div style="display:flex; align-items: center; gap: 5px;">
                ...
                <div style="display:flex; gap:2px;">
                    ${n.doraMarkers.map(s=>`<div style="width:28px; height:38px;">${this.getTileHtml(s)}</div>`).join("")}
                </div>
            </div>
        `,e.appendChild(t);let o=[0,-90,180,90];n.players.forEach((s,a)=>{let z=(a-this.viewpoint+4)%4,m=document.createElement("div");Object.assign(m.style,{position:"absolute",top:"50%",left:"50%",width:"0",height:"0",display:"flex",justifyContent:"center",transform:`rotate(${o[z]}deg)`});let c=document.createElement("div");if(Object.assign(c.style,{width:"600px",height:"auto",minHeight:"220px",display:"flex",flexDirection:"column",alignItems:"center",transform:"translateY(140px)",transition:"background-color 0.3s",position:"relative"}),a===n.currentActor&&c.classList.add("active-player-highlight"),c.style.padding="10px",n.lastEvent&&n.lastEvent.actor===a){let i="",r=n.lastEvent.type;if(["chi","pon","kan","ankan","daiminkan","kakan"].includes(r)?(i=r.charAt(0).toUpperCase()+r.slice(1),r==="daiminkan"&&(i="Kan"),r==="ankan"&&(i="Ankan"),r==="kakan"&&(i="Kakan")):r==="hora"&&(n.lastEvent.target===n.lastEvent.actor?i="Tsumo":i="Ron"),i){let l=document.createElement("div");l.className="call-overlay",l.textContent=i,c.appendChild(l)}}let p=document.createElement("div"),w=`P${a}`;p.innerHTML=`<span style="font-weight:bold; font-size:1.1em; margin-right:8px;">${w}</span> <span style="font-family:monospace; font-size:1.3em;">${s.score}</span>`,s.riichi&&(p.style.color="#ff6b6b",p.innerHTML+=' <span style="font-weight:bold; border:2px solid currentColor; padding:0 4px; border-radius:4px; font-size:0.9em; margin-left:8px;">REACH</span>'),p.style.marginBottom="8px",p.style.textShadow="1px 1px 2px #000";let f=document.createElement("div");f.className="river-grid",s.discards.forEach(i=>{let r=document.createElement("div");if(r.style.width="34px",r.style.height="46px",r.style.position="relative",i.isRiichi){let l=document.createElement("div");l.style.width="100%",l.style.height="100%",l.className="tile-rotated",l.innerHTML=this.getTileHtml(i.tile),r.appendChild(l)}else r.innerHTML=this.getTileHtml(i.tile);f.appendChild(r)});let d=document.createElement("div");d.style.display="flex",d.style.alignItems="flex-end",d.style.marginTop="15px",d.style.height="56px";let x=document.createElement("div");Object.assign(x.style,{display:"flex",width:"570px",height:"56px",justifyContent:"flex-start"});let h=(s.hand.length+s.melds.length*3)%3===2;if(s.hand.forEach((i,r)=>{let l=document.createElement("div");l.style.width="40px",l.style.height="56px",l.innerHTML=this.getTileHtml(i),h&&r===s.hand.length-1&&(l.style.marginLeft="10px"),x.appendChild(l)}),d.appendChild(x),s.melds.length>0){let i=document.createElement("div");i.style.display="flex",i.style.gap="8px",i.style.marginLeft="10px",s.melds.forEach(r=>{let l=document.createElement("div");l.style.display="flex",r.tiles.forEach(y=>{let g=document.createElement("div");g.style.width="34px",g.style.height="46px",g.innerHTML=this.getTileHtml(y),l.appendChild(g)}),i.appendChild(l)}),d.appendChild(i)}c.appendChild(p),c.appendChild(f),c.appendChild(d),m.appendChild(c),e.appendChild(m)}),this.container.appendChild(e)}formatRound(n){return`${["East","South","West","North"][Math.floor(n/4)]} ${n%4+1}`}};var j=class{constructor(n,e){let t=document.getElementById(n);if(!t)throw new Error(`Container #${n} not found`);this.container=t,this.log=e,this.container.innerHTML="";let o=document.createElement("div");o.id=`${n}-board`,Object.assign(o.style,{display:"flex",justifyContent:"center",alignItems:"flex-start",width:"100%",overflow:"auto"}),this.container.appendChild(o),this.controlPanel=document.createElement("div"),Object.assign(this.controlPanel.style,{display:"flex",gap:"10px",justifyContent:"center",marginTop:"10px",padding:"10px",backgroundColor:"#f0f0f0",borderRadius:"4px"}),this.container.appendChild(this.controlPanel),this.gameState=new v(e),this.renderer=new b(o),this.initControls(),this.update()}initControls(){this.controlPanel.innerHTML="",this.controlPanel.style.flexDirection="column",this.controlPanel.style.alignItems="center";let n="display: flex; gap: 10px; align-items: center; justify-content: center; margin-bottom: 8px; flex-wrap: wrap;",e="padding: 6px 12px; cursor: pointer; border: 1px solid #ccc; background: white; border-radius: 4px; font-weight: bold; font-family: sans-serif;",t=(i,r,l)=>{let y=document.createElement("button");return y.textContent=i,y.style.cssText=e,y.onclick=r,l&&(y.title=l),y},o=document.createElement("div");o.style.cssText=n;let s=t("<< Turn",()=>{this.gameState.stepTurn(!1,this.renderer.viewpoint),this.update()},"Previous Turn (Viewpoint Player)"),a=t("< Step",()=>{this.gameState.stepBackward()&&this.update()}),z=t("Step >",()=>{this.gameState.stepForward()&&this.update()}),m=t("Turn >>",()=>{this.gameState.stepTurn(!0,this.renderer.viewpoint),this.update()},"Next Turn (Viewpoint Player)");o.appendChild(s),o.appendChild(a),o.appendChild(z),o.appendChild(m);let c=document.createElement("div");c.style.cssText=n;let p=document.createElement("select");p.style.padding="5px",p.style.borderRadius="4px";let w=this.gameState.getKyokuCheckpoints(),f=document.createElement("option");f.value="0",f.text="Start Game",p.appendChild(f),w.forEach(i=>{let r=document.createElement("option");r.value=i.index.toString(),r.text=`${this.renderer.formatRound(i.round)} - ${i.honba} Honba`,p.appendChild(r)}),p.onchange=()=>{this.gameState.jumpTo(parseInt(p.value)),this.update()},this.kyokuSelect=p;let d=document.createElement("select");d.style.padding="5px",d.style.borderRadius="4px",["Self (P0)","Right (P1)","Opp (P2)","Left (P3)"].forEach((i,r)=>{let l=document.createElement("option");l.value=r.toString(),l.text=i,d.appendChild(l)}),d.value="0",d.onchange=()=>{this.renderer.viewpoint=parseInt(d.value),this.update()},this.viewpointSelect=d;let x=t("Prev Kyoku",()=>{let i=0;for(let r of w)if(r.index<this.gameState.cursor-5)i=r.index;else break;this.gameState.jumpTo(i),this.update()}),_=t("Next Kyoku",()=>{let i=w.find(r=>r.index>this.gameState.cursor);i&&(this.gameState.jumpTo(i.index),this.update())});c.appendChild(x),c.appendChild(p),c.appendChild(_);let h=document.createElement("span");h.style.margin="0 10px",h.style.borderLeft="1px solid #999",h.style.height="20px",c.appendChild(h),c.appendChild(d),this.controlPanel.appendChild(o),this.controlPanel.appendChild(c)}update(){this.renderer.render(this.gameState.current);let n=this.gameState.getKyokuCheckpoints(),e=0;for(let t of n)if(t.index<=this.gameState.cursor)e=t.index;else break;this.kyokuSelect&&(this.kyokuSelect.value=e.toString())}};window.RiichiEnvViewer=j;return M(E);})();
